...
impl FileTypeExt {
    ...
    pub(crate) const fn from_raw_mode(mode: RawMode) -> FileType {
        match rsix::fs::FileType::from_raw_mode(mode) {
            rsix::fs::FileType::RegularFile => FileType::file(),
            rsix::fs::FileType::Directory => FileType::dir(),
            rsix::fs::FileType::Symlink => FileType::ext(Self::symlink()),
            rsix::fs::FileType::Fifo => FileType::ext(Self::fifo()),
            rsix::fs::FileType::CharacterDevice => FileType::ext(Self::char_device()),
            rsix::fs::FileType::BlockDevice => FileType::ext(Self::block_device()),
            rsix::fs::FileType::Socket => FileType::ext(Self::socket()),
            _ => FileType::unknown(),
        }
    }
