...
/// methods correspond to the several functions in [`tokio::net`].
///
...
impl Pool {
    ...
    /// Add a specific [`std::net::SocketAddr`] to the pool.
    ///
    /// # Ambient Authority
    ///
    /// This function allows ambient access to any IP address.
    ...
    /// address.
    ///
    /// This corresponds to [`tokio::net::TcpListener::bind`].
    #[doc(alias = "bind")]
    #[inline]
    ...
    ///
    /// This corresponds to [`tokio::net::TcpStream::connect`].
    #[doc(alias = "connect")]
    #[inline]
    ...
    ///
    /// This corresponds to [`tokio::net::UdpSocket::bind`].
    #[doc(alias = "bind")]
    #[inline]
    ...
    ///
    /// This corresponds to [`tokio::net::UdpSocket::send_to`].
    #[doc(alias = "send_to")]
    #[inline]
    ...
    ///
    /// This corresponds to [`tokio::net::UdpSocket::connect`].
    #[doc(alias = "connect")]
    #[inline]
