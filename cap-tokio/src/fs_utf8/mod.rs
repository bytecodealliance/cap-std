//! A fully UTF-8 filesystem API modeled after [`cap_tokio::fs`].
//!
//! Where `cap_tokio::fs` would use `Path` and `PathBuf`, this `fs_utf8`
//! module uses [`Utf8Path`] and [`Utf8PathBuf`], meaning that all paths are
//! valid UTF-8.
//!
//! If you don't want this, use the regular [`cap_tokio::fs`] module
//! instead.
//!
//! [`cap_tokio::fs`]: ../fs/
